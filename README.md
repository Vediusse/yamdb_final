...
```
http://158.160.57.170/api/v1/titles/
```
```
{
  "count": 0,
...
```
http://158.160.57.170/api/v1/titles/{title_id}/reviews/{review_id}/
```
```
{
  "id": 0,
...
```
* Остальные примеры запросов можно посмотреть по [ссылке](http://158.160.57.170/redoc/) после запуска проект
